...
[SD_NULL_relabel, FD_NULL_relabel, FR_NULL_relabel]=FDFR_Rao_q (ab_table_real, dij_relabel);

% NULL-composition-2
ab_table_NULL_OTU1=OTU_table_random( ab_table_real, 4 );
[SD_NULL_OTU1, FD_NULL_OTU1, FR_NULL_OTU1]=FDFR_Rao_q (ab_table_NULL_OTU1, dij_real);

% NULL-composition-3
ab_table_NULL_OTU2=OTU_table_random( ab_table_real, 5 );
[SD_NULL_OTU2, FD_NULL_OTU2, FR_NULL_OTU2]=FDFR_Rao_q (ab_table_NULL_OTU2, dij_real);
